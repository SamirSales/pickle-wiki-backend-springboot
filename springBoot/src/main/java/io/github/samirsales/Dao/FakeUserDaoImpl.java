    ...
    public User getUserByLogin(String login) {
        ...
        for(User user : users){
            if(user.getLogin().equals(login) || user.getEmail().equals(login)){
                ...
                if(user.getPermissions().contains(Permission.EDITOR)){
                    userToReturn.getPermissions().add(Permission.EDITOR);
                }

                if(user.getPermissions().contains(Permission.ADMIN)){
                    userToReturn.getPermissions().add(Permission.ADMIN);
                }
